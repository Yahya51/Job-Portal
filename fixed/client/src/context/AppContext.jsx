...
export const AppContextProvider = (props) => {
    ...
    const fetchJobs = async () => {
        try {
            ...
            else { toast.error(data.message); setJobs(jobsData) }
        } catch (error) { toast.error(error.message); setJobs(jobsData) }
    };
    ...
    useEffect(() => { if (user) { fetchUserData(); fetchUserApplications() } }, [user])
